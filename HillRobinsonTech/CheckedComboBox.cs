...
namespace HillRobinsonTech
{
    public class CheckedComboBox : ComboBox {       
        ...
        internal class Dropdown : Form
        {
            ...
            private CustomCheckedListBox cclbLocation;
            ...
            public CustomCheckedListBox ListLocation
            {
                get { return cclbLocation; }
                set { cclbLocation = value; }
            }
            ...
            private void InitializeComponent()
            {
                ...
                this.cclbLocation = new CustomCheckedListBox();
                this.SuspendLayout();
                // 
                // cclb
                // 
                this.cclb.BorderStyle = System.Windows.Forms.BorderStyle.None;
                this.cclbLocation.BorderStyle = System.Windows.Forms.BorderStyle.None;
                this.cclb.Dock = System.Windows.Forms.DockStyle.Fill;
                this.cclbLocation.Dock = System.Windows.Forms.DockStyle.Fill;
                this.cclb.FormattingEnabled = true;
                this.cclbLocation.FormattingEnabled = true;
                this.cclb.Location = new System.Drawing.Point(0, 0);
                this.cclbLocation.Location = new System.Drawing.Point(0, 0);
                this.cclb.Name = "cclb";
                this.cclbLocation.Name = "cclbLocation";
                this.cclb.Size = new System.Drawing.Size(47, 15);
                this.cclbLocation.Size = new System.Drawing.Size(47, 15);
                this.cclb.TabIndex = 0;
                this.cclbLocation.TabIndex = 0;
                // 
                // Dropdown
                // 
            ...
            {               
                if (dropdownClosed)//&& Util.CloseDropdownNr % 2 != 0
                {
                    return;
                }
            ...
            protected override void OnActivated(EventArgs e)
            {
                ...
                //oldStrValueLocation = ccbParentLocation.Text;
            ...
            {               
                ...
                string objsender = ccbParent.Items[e.Index].ToString();
                //((System.Windows.Forms.CheckedListBox)(sender)).Text;                      
                int count = ccbParent.CheckedIndices.Count;
                ...
                if (((System.Windows.Forms.CheckedListBox)(sender)).Text.ToLower() == "all")
                {
                    if (objsender.ToLower() == "all" && e.NewValue == CheckState.Unchecked)
                    {
                        ccbParent.ItemCheck -= new System.Windows.Forms.ItemCheckEventHandler(ccbParent.ItemCheck);
                        UncheckedAll(ccbParent);
                        ccbParent.ItemCheck += new System.Windows.Forms.ItemCheckEventHandler(ccbParent.ItemCheck);
                    ...
                    if ((ccbParent.Items[e.Index].ToString().ToLower() != "" && ccbParent.Items[e.Index].ToString().ToLower() != "all") && e.NewValue == CheckState.Unchecked)
                    {
                        ccbParent.ItemCheck -= new System.Windows.Forms.ItemCheckEventHandler(ccbParent.ItemCheck);
                        ccbParent.SetItemChecked(0, false);
                        ccbParent.ItemCheck += new System.Windows.Forms.ItemCheckEventHandler(ccbParent.ItemCheck);
                    }
                    else if ((objsender.ToLower() != "" && objsender.ToLower() != "all") && count == (ccbParent.Items.Count - 1))
                    {
                        ccbParent.ItemCheck -= new System.Windows.Forms.ItemCheckEventHandler(ccbParent.ItemCheck);
                        ccbParent.SetItemChecked(0, true);
                        ccbParent.ItemCheck += new System.Windows.Forms.ItemCheckEventHandler(ccbParent.ItemCheck);
                    }    
            ...
            {
                for (int i = 1; i < objCombo.Items.Count; i++)
                {
        ...
        //public event ItemCheckEventHandler ValueMemberChanged;
